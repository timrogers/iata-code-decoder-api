# ✈️ IATA Code Decoder API

A simple API, written in Node.js with the Fastify framework, which allows you to identify airports ✈️, airlines 🛫 and aircraft 🛩️ by their IATA code.
