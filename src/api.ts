...
/**
 * Performance optimization: Warm up the caches during startup.
 * This ensures that the datasets are loaded, camelized, and indexed before
 * the first request arrives, eliminating cold-start latency.
 */
getAirportsMap();
getAirlinesMap();
getAircraftMap();
