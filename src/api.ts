...
// Eagerly warm up the caches at startup to eliminate cold-start latency
...
// Including 'required' and 'additionalProperties: false' allows fast-json-stringify
// to generate the most efficient serialization code.
const airportSchema = {
  type: 'object',
  required: [
    'id',
