...
// Eagerly warm up the prefix maps at startup to reduce cold-start latency for the first request.
// Each dataset (Airports, Airlines, Aircraft) is indexed once during module initialization.
getAirportsMap();
getAirlinesMap();
getAircraftMap();
