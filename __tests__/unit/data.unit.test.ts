...
describe('Data Modules - Unit Tests', () => {
  ...
  describe('AIRPORTS data', () => {
    ...
    it('should have airports with 3-character IATA codes', () => {
      const airportsWithInvalidCodes = AIRPORTS.filter(airport => 
        !airport.iataCode || airport.iataCode.length !== 3
      );
  ...
  describe('AIRLINES data', () => {
    ...
    it('should only include airlines with valid IATA codes (filtered)', () => {
      const airlinesWithoutCodes = AIRLINES.filter(airline => 
        !airline.iataCode || airline.iataCode === null || airline.iataCode === undefined
      );
    ...
    it('should have airlines with 2-character IATA codes', () => {
      const airlinesWithInvalidCodes = AIRLINES.filter(airline => 
        !airline.iataCode || airline.iataCode.length !== 2
      );
  ...
  describe('AIRCRAFT data', () => {
    ...
    it('should have aircraft with valid IATA codes', () => {
      const aircraftWithInvalidCodes = AIRCRAFT.filter(aircraft => 
        !aircraft.iataCode || aircraft.iataCode.length === 0 || aircraft.iataCode.length > 3
      );
    ...
    it('should contain expected aircraft types', () => {
      const commonAircraft = ['737', '747', '777', '320', '330', '319'];
    ...
    it('should have Boeing aircraft in the dataset', () => {
      const boeingAircraft = AIRCRAFT.filter(aircraft => 
    ...
    it('should have Airbus aircraft in the dataset', () => {
      const airbusAircraft = AIRCRAFT.filter(aircraft => 
