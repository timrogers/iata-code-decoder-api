...
describe('IATA Code Decoder API - Integration Tests', () => {
  ...
  describe('CORS', () => {
    it('should include Access-Control-Allow-Origin: * header on GET /airports', async () => {
      const response = await app.inject({
        method: 'GET',
        url: '/airports?query=LHR',
    ...
    it('should include Access-Control-Allow-Origin: * header on GET /airlines', async () => {
      const response = await app.inject({
        method: 'GET',
        url: '/airlines?query=BA',
        headers: { Origin: 'https://example.com' },
    ...
    it('should include Access-Control-Allow-Origin: * header on GET /aircraft', async () => {
      const response = await app.inject({
        method: 'GET',
        url: '/aircraft?query=777',
        headers: { Origin: 'https://example.com' },
