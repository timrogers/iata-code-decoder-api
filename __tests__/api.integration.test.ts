...
describe('IATA Code Decoder API - Integration Tests', () => {
  ...
  describe('GET /', () => {
    it('should return 200 with API documentation URL', async () => {
  ...
  describe('GET /airports', () => {
    it('should return all airports when query parameter is missing', async () => {
      const response = await app.inject({
        method: 'GET',
        url: '/airports',
      });
  ...
  describe('GET /aircraft', () => {
    it('should return all aircraft when query parameter is missing', async () => {
      const response = await app.inject({
        method: 'GET',
        url: '/aircraft',
      });
    ...
    it('should return all aircraft when query parameter is empty', async () => {
      const response = await app.inject({
        method: 'GET',
        url: '/aircraft?query=',
      });
